...
5. Windows might show a security prompt. If you trust the source, select "Run anyway" to proceed.
...
2. Locate the field labeled "API Key."
3. Paste your key into this box.
...
1. Select "New Project" from the main screen. 
2. Provide a title for your document.
3. Import your transcript file. The application accepts common text formats.
4. Choose an output format. Options include Docusaurus, GitBook, or standard Markdown.
